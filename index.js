...
const CONNECTED_WA = "+2349127745435";
const API_KEY = "UAKf0fb1f65-92ea-4ec9-9629-a1960b755eb6";


const META_ACCESS_TOKEN = "EAAJgi17vyDYBPTGf8m4LNp0xFdUozhBKS6PTnrElQdSZCIRZCnuLFmBigzRvB4ZCUI8EBNuNZCFZBfG5e11ehZBujToi9S6zYQ3HSmDZBPNQHZBFFrd3ntSZAl6lRZAOa86mOZCp60VaaCMhgUN6s68EEvYSEJXlaIk9iiB7xe1rlZBKbEVf7YiIADUZA0kHuO9nr0QZDZD";
const PHONE_NUMBER_ID = "669101662914614";

const token = "7679290855:AAFP9jWfiI8u66RlQc3w1NTkK-ToxF2t5uc";
const OWNER_ID = 8466164444;
const GROUP_ID = "@ban_bot_community_group";
...
bot.onText(/\/start/, async (msg) => {
  ...
  if (!joined) {
    return bot.sendPhoto(chatId, "./bot_data/start.jpg", {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: "Chatting Squad ✅", url: "https://t.me/chatting_arenas" }],
          [{ text: "Ban And Unban Group 💯", url: "https://t.me/ban_bot_community_group" }],
          [{ text: "Join Channel ⏳", url: "https://t.me/Cryptolordhimself3" }],
        ],
      },
    });
  }
...
`💡 Tip: Always ensure proxies are active before running ban operations.`,
  ...
  bot.sendPhoto(chatId, "./bot_data/start.jpg", {
    ...
    reply_markup: {
      inline_keyboard: [
        [
          { text: "💬 Chat Owner", url: "https://t.me/Cryptolordhimself2" },
          { text: "📢 View Channel", url: "https://t.me/Cryptolordhimself3" },
        ],
        [
          { text: "👥 Vip Group", url: "https://t.me/ban_bot_community_group" }
        ]
      ],
    },
  }).catch(() => {
...
┣ 📈 Success Rate: ${((stats.available / stats.total) * 100).toFixed(1)}%
┗━━━━━━━━━━━━━━━━━━┛
...
console.log("🤖 ENHANCED BOT IS RUNNING - 6000+ PROXY ROTATION ACTIVATED");